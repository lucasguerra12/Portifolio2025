...
const projectsData = [
  ...
  },
  {
    ...
    imageMain: byte10,
    imageOverlay: byte20,
    link: 'https://github.com/Byte-Team-Fatec/Byte_Team-API-1-',
    semester: 'Primeiro Semestre',
    partner: 'Fatec (Prof. Jean e Masanori)',
    problem: 'O problema central identificado foi a dificuldade de acesso e compreensão dos dados legislativos disponibilizados pela Câmara Municipal de São José dos Campos. As informações sobre a atuação dos vereadores estavam dispersas em portais de difícil navegação, dificultando o acompanhamento e a fiscalização por parte da população e dos eleitores.',
    solution: 'A equipe desenvolveu uma Aplicação Web informativa que centraliza e organiza os dados referentes aos vereadores. O sistema permite que qualquer cidadão visualize rapidamente indicadores de produtividade, como presenças, faltas e proposições apresentadas, promovendo a transparência pública de forma acessível e visual.',
    contributions: 'Atuei como Product Owner (PO). Minha principal contribuição foi a gestão do backlog no Jira e a mediação entre os requisitos acadêmicos e a capacidade de entrega do time. Sendo um projeto de primeiro semestre, fui responsável por organizar as tarefas de forma a garantir que a equipe conseguisse aprender as tecnologias e, simultaneamente, entregar um produto funcional.',
    hardSkillsText: 'HTML5 (Faço com autonomia), CSS3 (Faço com autonomia), JavaScript (Faço com autonomia), Python (Faço com ajuda), Flask (Faço com ajuda), MySQL (Faço com ajuda), Figma (Faço com autonomia), Jira (Faço com autonomia), Git (Faço com autonomia)',
    softSkills: 'Liderança e Empatia: O maior desafio foi conciliar a curva de aprendizado de uma equipe iniciante com a necessidade de uma entrega profissional. Exerci liderança ao adaptar o escopo das sprints à realidade técnica do time, mantendo a motivação e garantindo que o aprendizado ocorresse em paralelo ao desenvolvimento, sem comprometer a qualidade final.',
  },
  {
    id: 3,
    ...
    partner: 'Helpnei',
    problem: 'O principal desafio identificado foi a falta de uma plataforma digital moderna e centralizada que conseguisse divulgar e valorizar as empresas patrocinadoras do programa Helpnei. A ausência dessa ferramenta dificultava a visibilidade dos parceiros e a atração de novos apoios para a causa social.',
    solution: 'Desenvolvimento de uma Aplicação Web interativa e responsiva (SPA). O sistema oferece um mapa dinâmico para localização dos parceiros e páginas de perfil para cada empresa. A solução modernizou a forma como o Helpnei expõe seus patrocinadores, agregando valor à marca e facilitando o acesso dos usuários.',
    contributions: 'Atuei como Desenvolvedor Front-end, utilizando React e TypeScript. Minha contribuição crucial foi na implementação da lógica de formulários e tratamento de dados. Identifiquei a necessidade de sanitizar e formatar rigorosamente os dados no cliente antes do envio para a API, garantindo que informações como endereços e contatos fossem armazenadas corretamente no banco.',
    hardSkillsText: 'React (Faço com autonomia), TypeScript (Faço com autonomia), Vite (Faço com autonomia), Supabase (Faço com ajuda), Vercel (Faço com autonomia), Integração de APIs (Faço com autonomia)',
    softSkills: 'Pensamento Analítico e Resolução de Problemas: Durante o desenvolvimento, notei que dados brutos inseridos pelos usuários poderiam quebrar a integração. Analisei o fluxo de dados e implementei validadores e formatadores no Front-end preventivamente, evitando retrabalho e garantindo a consistência das informações enviadas ao Back-end.',
  },
  {
    id: 4, 
    title: 'Synex', 
    ...
    solution: 'Criação de uma Landing Page Web de alta conversão, com design limpo, tipografia moderna e animações sutis. A página foi otimizada para carregamento rápido e construída com HTML semântico e CSS moderno para garantir acessibilidade e SEO.',
  ...
  },
  {
    ...
    solution: 'Desenvolvimento de um Dashboard Web administrativo robusto utilizando Django. O sistema oferece painéis visuais para monitoramento de métricas, cadastro de aeronaves e controle de operações, facilitando a tomada de decisão.',
  ...
  },
  {
    ...
    solution: 'Implementação de uma Plataforma Web de e-commerce com tema escuro nativo (Dark Mode), focada em estética e fluidez. O design foi pensado para destacar produtos em ambientes de baixo contraste, com navegação intuitiva em dispositivos móveis.',
  ...
  },
  {
    ...
    partner: 'GSW',
    problem: 'O desafio proposto consistia em resolver uma necessidade recorrente de equipes e profissionais individuais: a dificuldade de organizar tarefas de forma colaborativa e visual. A falta de ferramentas integradas impactava a produtividade e dificultava o acompanhamento de prazos e metas em tempo real.',
    solution: 'A solução desenvolvida foi o GSW Task Manager, uma Aplicação Web colaborativa baseada na metodologia Kanban. O sistema permite criar, gerenciar e acompanhar tarefas em tempo real, organizando fluxos de trabalho através de quadros, colunas de status e prioridades, centralizando a comunicação da equipe.',
    contributions: 'Atuei como Desenvolvedor Back-end (Java/Spring). Fui responsável pela criação de endpoints RESTful seguros e pela integração com o banco de dados. Além da codificação, minha contribuição fundamental foi na postura profissional adotada diante das dificuldades de gestão da equipe, garantindo que os conflitos internos não impedissem a entrega técnica.',
    hardSkillsText: 'HTML5 (Faço com autonomia), CSS3 (Faço com autonomia), JavaScript (Faço com autonomia), TypeScript (Faço com autonomia), React (Faço com autonomia), Node.js (Faço com ajuda), Java (Spring) (Faço com ajuda), MongoDB (Faço com ajuda), Git (Faço com autonomia), Jira (Faço com autonomia)',
    softSkills: 'Inteligência Emocional e Resiliência: Durante o projeto, o time enfrentou desafios significativos de gestão devido à mistura de relações pessoais com profissionais. Utilizei minha inteligência emocional para separar amizade de trabalho, mantendo o rigor nos processos do Scrum e o foco nas entregas, o que foi vital para contornar as instabilidades do grupo e finalizar o projeto.',
  },
  {
    id: 9, 
    title: 'Pratik', 
    ...
    solution: 'Desenvolvimento de uma Aplicação Web (PWA) que facilita a conexão entre clientes e profissionais. O sistema conta com busca por categoria, perfis de prestadores e interface simplificada para solicitação de serviços.',
